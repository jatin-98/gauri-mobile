...
<div class="container-fluid">
    <div class="page-title">
        <div class="row">
            <div class="col-6">
                <h3><i data-feather="settings"></i> Settings</h3>
            </div>
            <div class="col-6">
                <ol class="breadcrumb">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\gg\views/admin/settings/index.blade.php ENDPATH**/ ?>