    ...
    <div class="invoice-wrapper">
            ...
            <table width="100%" style="border: none;">
                <tr>
                    ...
                    <td width="40%" class="text-right" style="border:none; padding:0;">
                        <strong>Invoice No:</strong> <?php echo e($invoice[0]->invoice_number); ?><br>
                        <strong>Invoice Date:</strong> <?php echo e(\Carbon\Carbon::parse($invoice[0]->created_at)->format('d-M-Y')); ?><br>
        ...
        <div class="mb-3">
            <table width="100%" style="border: none;">
                <tr>
                    <td width="60%" style="border:none; padding:0;">
                        <strong>Customer Name:</strong> Mr. <?php echo e($invoice[0]->customer_name); ?><br>
                        <strong>Phone:</strong> +91-<?php echo e($invoice[0]->customer_phone); ?><br>
                        <strong>Address:</strong> <?php echo e($invoice[0]->billing_address); ?>

                    </td>
                    <td width="40%" class="text-right" style="border:none; padding:0;">
                        <strong>Member No:</strong> 655310298393120<br>
                        <strong>Salesman:</strong> MANISH - 9711115387<br>
                        <strong>Payment:</strong> <?php echo e($invoice[0]->payment_method); ?> <span class="rupee-symbol">&#8377;</span><?php echo e(number_format($invoice[0]->invoice_total, 2)); ?>
        ...
        <table class="mb-4">
            ...
            <tbody>
                <?php $subtotal = 0; ?>
                <?php $__currentLoopData = $invoice; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php $subtotal += $item->total; ?>
                <tr>
                    <td class="text-center"><?php echo e($loop->iteration); ?></td>
                    <td><?php echo e($item->product_name); ?></td>
                    <td class="text-center"><?php echo e($item->product_description ?? '85171300'); ?></td>
                    <td class="text-center"><?php echo e($item->quantity); ?></td>
                    <td class="text-right"><span class="rupee-symbol">&#8377;</span><?php echo e(number_format($item->price, 0)); ?></td>
                    <td class="text-right"><span class="rupee-symbol">&#8377;</span><?php echo e(number_format($item->taxable_value ?? $item->price, 0)); ?></td>
                    <td class="text-center"><?php echo e($item->cgst_rate ?? '9'); ?>%</td>
                    <td class="text-center"><?php echo e($item->sgst_rate ?? '9'); ?>%</td>
                    <td class="text-center"><?php echo e($item->igst_rate ?? '0'); ?>%</td>
                    <td class="text-right"><span class="rupee-symbol">&#8377;</span><?php echo e(number_format($item->total, 0)); ?></td>
                </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                
                <?php for($i = count($invoice); $i < 8; $i++): ?>
                    <tr class="empty-row">
                    <td>&nbsp;</td>
                    <td></td>
                    <td></td>
                    ...
                    <tr class="total-row">
                        ...
                        <th class="text-right"><span class="rupee-symbol">&#8377;</span><?php echo e(number_format($subtotal, 0)); ?></th>
                    </tr>

                    
                    <?php if(($invoice[0]->discount ?? 0) > 0): ?>
                    <tr>
                        <th colspan="9" class="text-right">Discount</th>
                        <th class="text-right">- <span class="rupee-symbol">&#8377;</span><?php echo e(number_format($invoice[0]->discount, 0)); ?></th>
                    </tr>
                    <?php endif; ?>
                    ...
                    <tr style="background:#f0f8ff;">
                        ...
                        <th class="text-right"><span class="rupee-symbol">&#8377;</span><?php echo e(number_format($invoice[0]->invoice_total, 0)); ?></th>
                    </tr>
            </tbody>
        </table>

        <div class="amount-words">
            Amount in Words: <span id="words" style="color:#000; font-weight:bold;"><?php echo e(numberToWords($invoice[0]->invoice_total)); ?>.</span>
        </div>
...
</html><?php /**PATH C:\xampp\htdocs\gauri-mobiles\views/admin/invoices/email.blade.php ENDPATH**/ ?>