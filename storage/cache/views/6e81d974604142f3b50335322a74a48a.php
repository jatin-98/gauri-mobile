                ...
                <div id="product-rows">
                    ...
                    <div class="row g-3 align-items-end mb-3 product-row">
                        ...
                        <div class="col-md-3">
                            ...
                            <input class="form-control" type="text" name="product_description[]" value="<?php echo e($item->product_description); ?>" placeholder="Enter product description">
                        </div>
                        <div class="col-md-1">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\gaurimobiles\views/admin/invoices/edit.blade.php ENDPATH**/ ?>