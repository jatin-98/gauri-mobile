    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
        ...
        <div class="error-wrapper">
            <div class="container"><img class="img-100" src="<?php echo e(asset('assets/images/other-images/sad.png')); ?>" alt="">
                ...
                <div><a class="btn btn-danger-gradien btn-lg" href="<?php echo e(url('')); ?>">BACK TO HOME PAGE</a></div>
            </div>
        </div>
        <!-- error-404 end      -->
    </div>
...
</html><?php /**PATH C:\xampp\htdocs\gauri-mobiles\views/default/404.blade.php ENDPATH**/ ?>