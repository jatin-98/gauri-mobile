...
<div class="container-fluid">
    ...
    <div class="row g-4 mb-4">
        <div class="col-xl-3 col-md-6">
            <div class="stats-card">
                <div class="d-flex align-items-center">
                    <div class="stats-icon me-3" style="background: var(--primary);">
                        <i class="fas fa-shopping-cart"></i>
                    </div>
                    <div>
                        <h4 class="mb-0">₹1,24,580</h4>
                        <p class="text-muted mb-0">Today's Sales</p>
                        <small class="text-success">+12.5% from yesterday</small>
                    </div>
                </div>
                <div id="sales-sparkline" class="small-chart"></div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="stats-card">
                <div class="d-flex align-items-center">
                    <div class="stats-icon me-3" style="background: var(--success);">
                        <i class="fas fa-rupee-sign"></i>
                    </div>
                    <div>
                        <h4 class="mb-0">₹85,420</h4>
                        <p class="text-muted mb-0">Total Profit</p>
                        <small class="text-success">+8.2% this month</small>
                    </div>
                </div>
                <div id="profit-sparkline" class="small-chart"></div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="stats-card">
                <div class="d-flex align-items-center">
                    <div class="stats-icon me-3" style="background: var(--info);">
                ...
                <div id="customers-sparkline" class="small-chart"></div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="stats-card">
                <div class="d-flex align-items-center">
                    <div class="stats-icon me-3" style="background: var(--warning);">
                        <i class="fas fa-box-open"></i>
                    </div>
                    <div>
                        <h4 class="mb-0">1,842</h4>
                        <p class="text-muted mb-0">Products Sold</p>
                        <small class="text-warning">96% of target</small>
                    </div>
                </div>
                <div id="products-sparkline" class="small-chart"></div>
            </div>
        </div>
    </div>
    ...
    <div class="row g-4">
        ...
        <div class="col-xl-12">
            <div class="row g-4">
                <div class="col-6">
                    <div class="metric-card" style="--gradient-start:#8b5cf6;--gradient-end:#3b82f6;">
                        <h5 class="mb-1">Monthly Target</h5>
                        <h3 class="mb-2">₹45.2L / ₹60L</h3>
                        <div class="progress" style="height: 8px;">
                            <div class="progress-bar bg-white" style="width: 75%;"></div>
                        </div>
                        <small>75% achieved • ₹14.8L remaining</small>
                    </div>
                </div>

                <div class="col-6">
                    <div class="greeting-card">
                        <h4>Great Job Today!</h4>
                        <p class="mb-4">You've already made <strong>₹1.24 Lakh</strong> in sales today — that's 18% above average!</p>
                    </div>
                </div>
            </div>
        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\gg\views/admin/dashboard.blade.php ENDPATH**/ ?>