...
@section('title', 'Invoice ' . $invoice[0]->invoice_number)
    ...
    <div class="page-title">
        <div class="row align-items-center">
            <div class="col-12 col-md-6">
                <h3>Invoice {{ $invoice[0]->invoice_number }}</h3>
            </div>
            <div class="col-12 col-md-6 text-md-end mt-3 mt-md-0">
                <ol class="breadcrumb justify-content-end mb-0">
                    <li class="breadcrumb-item"><a href="{{ url('/admin') }}"><i data-feather="home"></i></a></li>
                    <li class="breadcrumb-item">Invoices</li>
                    <li class="breadcrumb-item active">{{ $invoice[0]->invoice_number }}</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex flex-wrap gap-3 justify-content-start align-items-center">
                ...
                <!-- Send Email Button -->
                <button class="btn btn-outline-success d-flex align-items-center gap-1" id="sendInvoiceBtn" data-id="{{ $invoice[0]->invoice_id }}">
...
<script>
    ...
    $('#sendInvoiceBtn').on('click', function() {
        ...
        $.ajax({
            url: "{{ url('/admin/send-invoice-to-customer/') }}",
            method: "POST",
            data: {
                invoiceId: invoiceId
            },
